...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2025 a las 17:19:43
...
INSERT INTO `obrasocial` (`Id_ObraSocial`, `Nombre`) VALUES
(1, 'Sin obra social');
...
--
ALTER TABLE `obrasocial`
  MODIFY `Id_ObraSocial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_usuario_cliente` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`Id_Cliente`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
